...
### A personal wiki imitate [Wikitten](https://wikitten.vizuina.com/) style for Hexo. >[Preview](http://wiki.vianlex.me/)
...
$ git clone https://github.com/vianlex/hexo-theme-Wikitten.git themes/Wikitten
```
...
nofollow:
  enable: true
  exclude:
    - <your site url domain> # eg: vianlex.me
```
