...
- 工作节点：主要负责执行运行服务的任务。
![Swarm 架构图](/images/docker-swarm.png)
...
![网格路由](/images/docker-swarm 网络路由.png)
