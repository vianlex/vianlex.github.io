- **Middleware 知识点**
  - [ShardingSphere 分库分表](/Middleware/ShardingSphere分库分表.md) 
  - [Kafka 学习笔记](/Middleware/Kafka学习笔记.md)
  - [Kafka 安装笔记](/Middleware/Kafka安装笔记.md)
  - [Kafka 消息缓存机制](/Middleware/Kafka生产者消息缓存机制.md)
  - [RocketMQ 学习笔记](/Middleware/RocketMQ学习笔记.md)
  - [Gateway 学习笔记](/Middleware/Gateway学习笔记.md)
  - [Nacos 学习笔记](/Middleware/Nacos学习笔记.md)
  - [OpenFeign 学习笔记](/Middleware/OpenFeign学习笔记.md)
  - [Sentinel 学习笔记](/Middleware/Sentinel学习笔记.md)
  - [SkyWalking 学习笔记](/Middleware/SkyWalking学习笔记.md)
  - [ES 基础概念学习笔记](/Middleware/ES基础概念笔记.md)
  - [ES 语法查询学习笔记](/Middleware/ES语法查询学习笔记.md)
...
- **Frontend 知识点**
  - [Node 环境配置记录](/Frontend/Node环境配置记录.md)
  - [JS的 bind、call、apply 用法](/Frontend/JavaScript中的bind用法.md)
  - [JS的 this 对象](/Frontend/JavaScript中的this对象.md)
  - [JS事件循环.md](/Frontend/JavaScript事件循环.md)
  - [JS变量声明和作用域](/Frontend/JavaScript变量声明和作用域.md)
  - [JS继承和原型链](/Frontend/JavaScript继承和原型链.md)
  - [JS正则表达式](/Frontend/JavaScript正则表达式.md)
...
- **Computer 网络**
  - [域名知识记录.md](/Computer/域名知识记录.md)
  - [网络设备知识记录](/Computer/网络设备知识记录.md)
  - [软件名称记录](/Computer/软件名称记录.md)
